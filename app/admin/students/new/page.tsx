    ...
    <div className="min-h-screen p-6">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="mb-8">
          ...
          <p className="text-white/40">Create a new student account</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <Input value={formData.matricNumber} onChange={e => setFormData({ ...formData, matricNumber: e.target.value })} placeholder="e.g., u2022/5570065" required />
                </div>
              </div>

              <div>
                <label className="block text-sm font-medium text-white/70 mb-2">Email Address</label>
                <Input type="email" value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} placeholder="e.g., john.doe@uniport.edu.ng" required />
              </div>
              ...
              <div>
                ...
                <Input type="password" value={formData.password} onChange={e => setFormData({ ...formData, password: e.target.value })} placeholder="Enter student password" required />
              </div>
